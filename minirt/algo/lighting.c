...
/*   Updated: 2025/03/01 23:42:27 by aloubry          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minirt.h"

t_color	compute_ambiant_lighting(t_color base_color, t_ambiant_light *ambiant_light)
{
...
t_color	compute_diffuse_lighting(t_color base_color, t_light *light, t_ray *light_ray, t_vector3 normal)
{
...
t_color	compute_specular_lighting(t_light *light, t_ray *light_ray, t_ray_hit_info *hit_info, t_vector3 normal)
{
	t_vector3	view_dir;
